...
#define K 2.0 //Fator de viscosidade, determinado por parâmetros geométricos da válvula e número de Reynolds
#define c_h 5193 //Calor específico do hélio [J/kg°C]
#define c_b 1753 //Calor específic do látex [J/kgK]


double grav(double r); //Função aceleração da gravidade local em m/s^2
double update_atm(double alt_0, double T0, double r, double r_ant, double g, double *T, double *p, double *rho);//Determina as propriedades termodinâmicas da atmosfera na posicao radial r
