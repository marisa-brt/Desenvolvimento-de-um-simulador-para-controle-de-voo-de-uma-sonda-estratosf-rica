...
int main(int argc, char* argv[])
{
    ...
    //Leitura de valores do raio do belão e do beta em arquivo
    ...
    while ( r - R_T <= 32000){
        ...
        //calculo k2
        k2[0] = h*drb_dt(d_r+k1[4]/2.0, T, P, r_b+k1[0]/2.0, ro_h, g, m, P_h, drb_dpm);
        k2[1] = h*(d_r+k1[4]/2.0);
        ...
        //calculo de k3
        k3[0] = h*drb_dt(d_r+k2[4]/2.0, T, P, r_b+k2[0]/2.0, ro_h, g, m, P_h, drb_dpm);
        k3[1] = h*(d_r+k2[4]/2.0);
        ...
        //calculo de k4
        k4[0] = h*drb_dt(d_r+k3[4], T, P, r_b+k3[0], ro_h, g, m, P_h, drb_dpm);
        k4[1] = h*(d_r+k3[4]);
        k4[2] = h*(d_theta+k3[5]);
