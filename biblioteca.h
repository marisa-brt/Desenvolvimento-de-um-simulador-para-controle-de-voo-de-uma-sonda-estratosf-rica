...
#define Ca 0.34234 //Constante de arrasto
...
#define Espessura 0.0001 //Espessura do balão
...
double raio_b(double P, double T, double m_h, double ro_h0, double r_b);//Função parao raio do balão em função da altitude e da deformação
