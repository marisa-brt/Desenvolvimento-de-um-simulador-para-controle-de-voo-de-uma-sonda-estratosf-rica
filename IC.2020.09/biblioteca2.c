...
double update_atm(double alt_0, double T0, double r, double r_ant, double g,
  ...
  //Determina as proprieades termodinâmicas da atmosfera na posicao radial r
  //T em K
  //p em Pa
  //rho em kg/m^3
  ...
  double grad_t1 = -4.9687e-3; //gradiente térmico na Troposfera (K/m)
